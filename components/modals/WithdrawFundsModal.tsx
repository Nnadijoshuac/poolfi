...
export default function WithdrawFundsModal({ isOpen, onClose, onCrypto, onFiat }: WithdrawFundsModalProps) {
  ...
  const options = [
    ...
    },
    {
      ...
      subtitle: 'Send via bank transfers',
      onClick: onFiat
    }
  ]
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="text-gray-600 text-sm mb-6">Select your payout option</p>
