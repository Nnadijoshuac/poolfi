...
/**
 * @title PoolFi - Decentralized Savings Pool Platform
 * @dev Built for Reef Ecosystem Hackathon
 * @author PoolFi Team
 * @notice Advanced savings pool system with crowdfunding capabilities
 */
contract PoolFi {
    struct Pool {
        uint256 id;
