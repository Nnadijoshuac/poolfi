          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold" style={{ fontSize: '8px', color: '#7fd1b9' }}>{pool.contributionAmount} REEF/month</span>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="font-semibold" style={{ fontSize: '8px', color: '#eac382' }}>Target</span>
                <span className="font-semibold" style={{ fontSize: '8px', color: '#eac382' }}>{pool.targetAmount} REEF</span>
              </div>
